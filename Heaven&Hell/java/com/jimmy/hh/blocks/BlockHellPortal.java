...
public class BlockHellPortal extends BlockBreakable
{
	public BlockHellPortal(String blockName)
	{
		super(Reference.MOD_ID + ":" + "hellPortal", Material.portal, false);
	...
	public boolean tryToCreatePortal(World par1World, int par2, int par3, int par4)
	{
		...
		else
		{
			...
			for (l = -1; l <= 2; ++l)
			{
				for (i1 = -1; i1 <= 3; ++i1)
				{
					...
					if (l != -1 && l != 2 || i1 != -1 && i1 != 3)
					{
						...
						else if (j1 != null && j1 != HHBlocks.heavenFire)
						{
							return false;
						}
					}
			...
			for (l = 0; l < 2; ++l)
			{
				for (i1 = 0; i1 < 3; ++i1)
				{
					par1World.setBlock(par2 + b0 * l, par3 + i1, par4 + b1 * l, HHBlocks.heavenPortal, 0, 2);
				}
			}
			return true;
		}
	...
	//CHANGE PORTAL SENDING LOCATION FOR HELL WORLD
