...
import com.jimmy.hh.dimension.world.genlayer.GenLayerHeaven;
...
public class WorldChunkMangerHeaven extends WorldChunkManager
{
	...
	protected WorldChunkMangerHeaven()
	{
		this.myBiomeCache = new BiomeCache(this);
		this.myBiomesToSpawnIn = new ArrayList<BiomeGenBase>();
		this.myBiomesToSpawnIn.add(HHBiomes.heaven);
	}

	public WorldChunkMangerHeaven(long seed, WorldType worldtype)
	{
		this();
		// i changed this to my GenLayerTutorial
		GenLayer[] agenlayer = GenLayerHeaven.makeTheWorld(seed);
		this.myGenBiomes = agenlayer[0];
		this.myBiomeIndexLayer = agenlayer[1];
	}

	public WorldChunkMangerHeaven(World world)
	{
	...
	public BiomeGenBase[] getBiomesForGeneration(BiomeGenBase[] par1ArrayOfBiomeGenBase, int par2, int par3, int par4, int par5) {
		...
		for (int i = 0; i < par4 * par5; ++i) {
			if (aint[i] >= 0) {
				...
				par1ArrayOfBiomeGenBase[i] = HHBiomes.heaven;
			}
		}
